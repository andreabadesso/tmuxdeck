defmodule RelayWeb.ConnCase do
  ...
  def register_and_log_in_account(%{conn: conn} = context) do
    account = Relay.AccountsFixtures.account_fixture()
    scope = Relay.Accounts.Scope.for_account(account)
  ...
  def log_in_account(conn, account, opts \\ []) do
    token = Relay.Accounts.generate_account_session_token(account)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Relay.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
